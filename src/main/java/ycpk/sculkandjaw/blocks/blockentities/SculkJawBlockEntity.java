...
public class SculkJawBlockEntity extends RandomizableContainerBlockEntity {
    public SculkJawBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SCULK_JAW_BLOCK_ENTITY.get(), pos, state);
    ...
    protected void saveAdditional(CompoundTag compoundTag) {
        ...
        if(!this.trySaveLootTable(compoundTag)) {
            ContainerHelper.saveAllItems(compoundTag, this.aItems);
        }
    }
    ...
    public void load(CompoundTag compoundTag) {
        ...
        if(!this.tryLoadLootTable(compoundTag)) {
            ContainerHelper.loadAllItems(compoundTag, this.aItems);
        }
    }
