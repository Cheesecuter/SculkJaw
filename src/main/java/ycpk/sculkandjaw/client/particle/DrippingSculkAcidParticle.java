...
public class DrippingSculkAcidParticle extends TextureSheetParticle {
    ...
    public static class SculkAcidLandProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel,
            ...
            DrippingSculkAcidParticle drippingSculkAcidParticle = new DripLandParticle(clientLevel, d, e, f, ModFluids.SCULK_ACID.get(), this.sprite);
    ...
    public static class SculkAcidFallProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel,
                                       double d, double e, double f,
                                       double g, double h, double i) {
            DrippingSculkAcidParticle drippingSculkAcidParticle = new FallAndLandParticle(clientLevel, d, e, f, ModFluids.SCULK_ACID.get(), ModParticleTypes.LANDING_SCULK_ACID.get(), this.sprite);
            ((DrippingSculkAcidParticle) drippingSculkAcidParticle).setColor(0.16F, 0.59F, 0.51F);
            return drippingSculkAcidParticle;
        }
    }
    ...
    public static class SculkAcidHangProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel,
                                       double d, double e, double f,
                                       double g, double h, double i) {
            DrippingSculkAcidParticle drippingSculkAcidParticle = new DripHangParticle(clientLevel, d, e, f, ModFluids.SCULK_ACID.get(), ModParticleTypes.DRIPPING_SCULK_ACID.get(), this.sprite);
            ((DrippingSculkAcidParticle) drippingSculkAcidParticle).setColor(0.16F, 0.59F, 0.51F);
            return drippingSculkAcidParticle;
        }
    }
    ...
    private static class DripHangParticle extends DrippingSculkAcidParticle {
        ...
        protected void preMoveUpdate() {
            if (this.lifetime-- <= 0) {
                this.remove();
                this.level.addParticle(ModParticleTypes.FALLING_SCULK_ACID.get(), this.x, this.y, this.z, this.xd, this.yd, this.zd);
            }
        }
