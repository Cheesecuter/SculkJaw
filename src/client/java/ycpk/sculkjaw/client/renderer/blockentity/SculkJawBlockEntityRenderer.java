...
public class SculkJawBlockEntityRenderer implements BlockEntityRenderer<SculkJawBlockEntity, SculkJawBlockEntityRenderState> {
    ...
    public static final Material SCULK_JAW_COMBINED_STOMACH = Sheets.BLOCK_ENTITIES_MAPPER.apply(ResourceLocation.fromNamespaceAndPath(Sculkjaw.MOD_ID, "sculk_jaw/sculk_jaw_combined_stomach"));
