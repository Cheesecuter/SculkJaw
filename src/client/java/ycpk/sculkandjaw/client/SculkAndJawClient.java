...
public class SculkAndJawClient implements ClientModInitializer {
    private static final ResourceLocation SCULK_ACID_STILL_TEXTURE =
            new ResourceLocation(SculkAndJaw.MOD_ID, "block/sculk_acid_still");
    private static final ResourceLocation SCULK_ACID_FLOWING_TEXTURE =
            new ResourceLocation(SculkAndJaw.MOD_ID, "block/sculk_acid_flow");
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.SCULK_ACID_CAULDRON, RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ACIDCOIL_CATTAIL, RenderType.cutout());
