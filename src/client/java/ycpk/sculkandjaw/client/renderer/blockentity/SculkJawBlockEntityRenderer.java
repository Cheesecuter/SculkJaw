...
public class SculkJawBlockEntityRenderer implements BlockEntityRenderer<SculkJawBlockEntity, SculkJawBlockEntityRenderState> {
    public static final Material SCULK_JAW_STOMACH = Sheets.BLOCK_ENTITIES_MAPPER.apply(Identifier.fromNamespaceAndPath(SculkAndJaw.MOD_ID, "sculk_jaw/sculk_jaw_stomach"));
    public static final Material SCULK_JAW_COMBINED_STOMACH = Sheets.BLOCK_ENTITIES_MAPPER.apply(Identifier.fromNamespaceAndPath(SculkAndJaw.MOD_ID, "sculk_jaw/sculk_jaw_combined_stomach"));
    ...
    public void submit(SculkJawBlockEntityRenderState sculkJawBlockEntityRenderState, PoseStack matrices,
        ...
        if(sculkJawBlockEntityRenderState.hasCombined) {
            ...
            RenderType renderType = SCULK_JAW_COMBINED_STOMACH.renderType(RenderTypes::entitySolid);
        ...
        RenderType renderType = SCULK_JAW_STOMACH.renderType(RenderTypes::entitySolid);
