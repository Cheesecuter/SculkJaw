...
public class SculkJawStomachModel {
    ...
    public static final Material SCULK_JAW_STOMACH = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(SculkAndJaw.MOD_ID, "entity/sculk_jaw/sculk_jaw_stomach"));
